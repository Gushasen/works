...
第二の引用で睦とモーティスの設定（同じ神の中の性格や意見の違い）にも使われているように感じられる。
睦とモーティスは言葉の引用元が岩波下巻アダムと岩波上巻アダムで別れているためその意味でも既に分裂させられているのだが、
さらに重ねてアダムが「神の子供」である設定を拾って父と子の関係性とキリストであることの意味も含めているのではないかと思う。
その上でサタンにとってのベルゼバブでもありサタンの子供『死』でもある。
ここまででも古典文学を引用した信じられないほど繊細な違法建築。
そこにさらにもう一つオリジナルキャラが投げ込まれていて正に狂気的な造形をしている。
